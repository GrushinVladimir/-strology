...
const ProfilePage = ({ telegramId }) => {
    ...
    const [showSupportModal, setShowSupportModal] = useState(false); // Состояние для модального окна
    ...
    const openSupportModal = () => {
        setShowSupportModal(true); // Открытие модального окна
    };

    const closeSupportModal = () => {
        setShowSupportModal(false); // Закрытие модального окна
    };
            ...
            <div className='body-profile'>
                ...
                <div className="header-profile">
                    ...
                    <div className="bottom-profile">
                        ...
                        <div>
                            <p onClick={openSupportModal} style={{ cursor: 'pointer', color: 'blue', textDecoration: 'underline' }}>Поддержка</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {showSupportModal && (
                <div className="support-modal">
                    <div className="modal-content">
                        ...
                        <button onClick={closeSupportModal} style={{ color: 'red', cursor: 'pointer' }}>Закрыть</button>
                    </div>
                </div>
            )}
