...
const Body = ({ step, userName, handleStart, handleNext, formData }) => {  
  ...
  const zodiacInfo = {
    "Водолей": "Водолей (лат. Aquarius) — Водолеи известны своей независимостью и оригинальностью.",
    "Рыбы": "Рыбы (лат. Pisces) — Рыбы сочетают в себе мечтательность и чувствительность.",
    "Овен": "Овен (лат. Aries) —  Овны известны своей энергией и настойчивостью.",
    "Телец": "Телец (лат. Taurus) —  Тельцы отличаются стабильностью и практичностью.",
    "Близнецы": "Близнецы (лат. Gemini) —  Близнецы известны своей общительностью и любознательностью.",
    "Рак": "Рак (лат. Cancer) —  Раки ценят семью и домашний уют.",
    "Лев": "Лев (лат. Leo) —  Львы известны своим харизматичным характером и стремлением быть в центре внимания.",
    "Дева": "Дева (лат. Virgo) —  Девы известны своим трудолюбием, организованностью и стремлением к порядку. Они редко мечтают о чем-то несбыточном, предпочитая практические и реалистичные подходы. Этот знак также ассоциируется со справедливостью и чистотой.",
    "Весы": "Весы (лат. Libra) — Весы отличаются стремлением к гармонии и справедливости, они ценят отношения и партнерство.",
    "Скорпион": "Скорпион (лат. Scorpio) — Скорпионы известны своей страстью, интенсивностью и загадочностью.",
    "Стрелец": "Стрелец (лат. Sagittarius) —  Стрельцы оптимистичны и любят приключения, ищут знания и новые впечатления.",
    "Козерог": "Козерог (лат. Capricornus) — Козероги известны своей целеустремленностью, дисциплиной и прагматизмом."
};
