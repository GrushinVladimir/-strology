...
const Body = ({ step, userName, handleStart, handleNext, formData }) => {  
  ...
  const zodiacInfo = {
    "Водолей": "Оригинальные и независимые, Водолеи всегда стремятся к переменам и новым идеям. ",
    "Рыбы": "Мечтательные и интуитивные, Рыбы живут в мире чувств и творчества, вдохновляя других.",
    "Овен": "Энергичный и смелый лидер, готовый к любым вызовам. Вы всегда стремитесь быть первыми.",
    "Телец": "Практичные и надежные, Тельцы ценят стабильность и комфорт в жизни. Они терпеливы и упорны.",
    "Близнецы": "Общительные и любопытные, Близнецы постоянно ищут новые знания и легко адаптируются к переменам. Управляющая планета: Меркурий.",
    "Рак": "Чуткие и заботливые, Раки глубоко привязаны к своим близким и ценят уют дома. Обладают сильной интуицией. Управляющая планета: Луна.",
    "Лев": "Уверенные в себе и щедрые, Львы обожают быть в центре внимания и вдохновлять окружающих.",
    "Дева": "Практичные и внимательные к деталям, Девы всегда стремятся к порядку и совершенству.",
    "Весы": "Дипломатичные и гармоничные, Весы ценят красоту и всегда ищут баланс во всем.",
    "Скорпион": "Страстные и целеустремленные, Скорпионы обладают мощной интуицией и силой воли.",
    "Стрелец": "Описание: Свободолюбивые оптимисты, Стрельцы всегда в поиске приключений и новых знаний.",
    "Козерог": "Ответственные и дисциплинированные, Козероги настойчиво идут к своим целям."
};
const zodiacPlan = {
  "Водолей": "Уран",
  "Рыбы": "ептун",
...
const zodiacKach = {
  "Водолей": "Оригинальность, Независимость, Прогрессивность",
  "Рыбы": "Чувствительность, Творчество, Сострадание",
  "Овен": "Смелость, Энергия, Решительность",
  "Телец": "Надежность, Упорство, Стабильность",
  "Близнецы": "Общительность, Гибкость, Интеллект",
  "Рак": "Эмоциональность, Забота, Интуиция",
  "Лев": "Лидерство, Щедрость, Харизма",
  "Дева": "Практичность, Аналитичность, Педантичность",
  "Весы": "Гармония, Дипломатия, Эстетика",
  "Скорпион": "Страсть, Интуиция, Решительность",
  "Стрелец": "Оптимизм, Свобода, Любознательность",
  "Козерог": "Ответственность, Дисциплина, Настойчивость"
};
