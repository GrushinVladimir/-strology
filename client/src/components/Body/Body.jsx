...
const Body = ({ step, userName, handleStart, handleNext, formData }) => {  
  ...
  const zodiacInfo = {
    "Водолей": "Оригинальные и независимые, Водолеи всегда стремятся к переменам и новым идеям. Управляющая планета: Уран. Основные качества: Оригинальность, Независимость, Прогрессивность",
    "Рыбы": "Мечтательные и интуитивные, Рыбы живут в мире чувств и творчества, вдохновляя других.Управляющая планета: Нептун. Основные качества: Чувствительность, Творчество, Сострадание",
    "Овен": "Энергичный и смелый лидер, готовый к любым вызовам. Вы всегда стремитесь быть первыми. Управляющая планета: Марс. Основные качества: Смелость, Энергия, Решительность",
    "Телец": "Практичные и надежные, Тельцы ценят стабильность и комфорт в жизни. Они терпеливы и упорны. Управляющая планета: Венера. Основные качества: Надежность, Упорство, Стабильность",
    "Близнецы": "Общительные и любопытные, Близнецы постоянно ищут новые знания и легко адаптируются к переменам. Управляющая планета: Меркурий. Основные качества: Общительность, Гибкость, Интеллект",
    "Рак": "Чуткие и заботливые, Раки глубоко привязаны к своим близким и ценят уют дома. Обладают сильной интуицией. Управляющая планета: Луна. Основные качества: Эмоциональность, Забота, Интуиция",
    "Лев": "Уверенные в себе и щедрые, Львы обожают быть в центре внимания и вдохновлять окружающих. Управляющая планета: Солнце. Основные качества: Лидерство, Щедрость, Харизма",
    "Дева": "Практичные и внимательные к деталям, Девы всегда стремятся к порядку и совершенству. Управляющая планета: Меркурий. Основные качества: Практичность, Аналитичность, Педантичность",
    "Весы": "Дипломатичные и гармоничные, Весы ценят красоту и всегда ищут баланс во всем. Управляющая планета: Венера. Основные качества: Гармония, Дипломатия, Эстетика",
    "Скорпион": "Страстные и целеустремленные, Скорпионы обладают мощной интуицией и силой воли. Управляющая планета: Плутон. Основные качества: Страсть, Интуиция, Решительность",
    "Стрелец": "Описание: Свободолюбивые оптимисты, Стрельцы всегда в поиске приключений и новых знаний. Управляющая планета: Юпитер. Основные качества: Оптимизм, Свобода, Любознательность",
    "Козерог": "Ответственные и дисциплинированные, Козероги настойчиво идут к своим целям. Управляющая планета: Сатурн. Основные качества: Ответственность, Дисциплина, Настойчивость"
};
const zodiacPlan = {
  "Водолей": "Управляющая планета: Уран",
  "Рыбы": "Управляющая планета: Нептун",
  "Овен": "Управляющая планета: Марс",
  "Телец": "Управляющая планета: Венера",
  "Близнецы": "Управляющая планета: Меркурий",
  "Рак": "Управляющая планета: Луна.",
  "Лев": "Управляющая планета: Солнце",
  "Дева": "Управляющая планета: Меркурий",
  "Весы": "Управляющая планета: Венера",
  "Скорпион": "Управляющая планета: Плутон",
  "Стрелец": "Управляющая планета: Юпитер",
  "Козерог": "Управляющая планета: Сатурн"
};
const zodiacKach = {
  "Водолей": "Основные качества: Оригинальность, Независимость, Прогрессивность",
  "Рыбы": "Основные качества: Чувствительность, Творчество, Сострадание",
  "Овен": "Основные качества: Смелость, Энергия, Решительность",
  "Телец": "Основные качества: Надежность, Упорство, Стабильность",
  "Близнецы": "Основные качества: Общительность, Гибкость, Интеллект",
  "Рак": "Основные качества: Эмоциональность, Забота, Интуиция",
  "Лев": "Основные качества: Лидерство, Щедрость, Харизма",
  "Дева": "Основные качества: Практичность, Аналитичность, Педантичность",
  "Весы": "Основные качества: Гармония, Дипломатия, Эстетика",
  "Скорпион": "Основные качества: Страсть, Интуиция, Решительность",
  "Стрелец": "Основные качества: Оптимизм, Свобода, Любознательность",
  "Козерог": "Основные качества: Ответственность, Дисциплина, Настойчивость"
};
    ...
    switch (step) {  
      ...
      case 3:  
        return (  
          ...
          {errorMessage && <p className="error-message" style={{marginTop: '0px'}}>{errorMessage}</p>}
